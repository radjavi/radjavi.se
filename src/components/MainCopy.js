...
class Page extends Component {
  ...
  render() {
    ...
    const PoseProject = posed.div({
      ...
      hoverable: true,
      init: {scale: ({active}) => active ? 1.1 : 1, transition: {duration: 200, ease: 'easeOut'}},
      hover: {scale: ({active}) => active ? 1.1 : 1.05, transition: {duration: 200, ease: 'easeOut'}}
    });
      ...
      <div className="Home">
        <div className="smallBody home-grid">
          <div className="about-grid">
            <header>
              <PoseLogo style={{position: "relative"}}>
            ...
            <div id="about-text-block">
              {(projectState == 0) && homePage}
              {(projectState == 1) && eatabeatPage}
            </div>
          </div>

          <div className="projects-grid">
            <PoseProject i="1" active={projectState == 1} id="project1" className="project-div" onClick={() => this.handleProjectClick(projectState == 0 ? 1 : 0)}>
            ...
            <PoseProject i="2" className="project-div"></PoseProject>
            <PoseProject i="3" className="project-div"></PoseProject>
            <PoseProject i="4" className="project-div"></PoseProject>
          </div>
        </div>
      </div>
    );
